...
This appendix presents additional examples of object-owned memory and derived pointers in CRuby, supplementing the string example in Section~\ref{sec:Background}.
