...
Additionally, derived pointers may be passed through multiple variables or returned from helper functions, requiring tracking of where pointer values originate. Full interprocedural tracking of pointer origins is expensive and may introduce additional imprecision.
